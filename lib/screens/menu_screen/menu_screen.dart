      ...
      child: Wrap(
        ...
        children: [
          _MenuTile(
            title: 'Equip',
            size: tileSize,
            backgroundAsset: 'assets/equip_icon.png',
            onTap: onEquipTap,
          ),
          _MenuTile(
            title: 'Shop',
            size: tileSize,
            backgroundAsset: 'assets/shop_icon.png',
            onTap: onShopTap,
          ),
          _MenuTile(
            title: 'Blacksmith',
            size: tileSize,
            backgroundAsset: 'assets/blacksmith_icon.png',
            onTap: onBlacksmithTap,
          ),
          _MenuTile(
            title: 'Skills',
            size: tileSize,
            backgroundAsset: 'assets/skills_icon.png',
            onTap: onSkillsTap,
          ),
        ],
      ),
