...
TextStyle scrollInfoTextDecoration = const TextStyle(fontSize: 18,color: Colors.grey,fontFamily: "PT Sans");

TextStyle scrollNameDecoration = const TextStyle(fontSize: 22,color: Colors.white,fontFamily: "PT Sans");

TextStyle scrollHintDecoration = const TextStyle(fontSize: 18,color: Colors.grey,fontFamily: "PT Sans");

TextStyle scrollWeaponName = const TextStyle(fontSize: 22,color: Colors.yellow,fontFamily: "PT Sans");

TextStyle scrollBottonsTextDecoration = const TextStyle(fontSize: 16,color: Colors.white,fontFamily: "PT Sans");
