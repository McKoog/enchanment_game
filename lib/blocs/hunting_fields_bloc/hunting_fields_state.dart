...
class HuntingFieldState$PickPhase extends HuntingFieldState{
  HuntingFieldState$PickPhase({required super.selectedWeapon, required super.selectedMonster});
}

class HuntingFieldState$HuntingStarted extends HuntingFieldState{
  HuntingFieldState$HuntingStarted({required super.selectedWeapon, required super.selectedMonster});
}